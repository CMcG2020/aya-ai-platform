...
const PathwaysContainer = () => {
  ...
  const categories = [
    ...
    { id: 'skills', name: 'Skills', icon: Filter },
  ]

  const filteredPathways = pathways.filter(pathway => 
    selectedCategory === 'all' || pathway.category === selectedCategory
  )
    ...
    <div className="section-container">
      ...
      <div className="mb-8">
        <p className="text-gray-600 text-center">
          <span className="font-semibold">{filteredPathways.length}</span> pathways available
